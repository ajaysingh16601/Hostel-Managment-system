...
function MessOff() {
  const getRequests = async () => {
    ...
    try {
      const data = await apiRequest("messoff/list", "POST", { hostel: hostel._id });
      setProgress(60);
  ...
  const updateRequest = async (id, status) => {
    try {
      const data = await apiRequest("messoff/update", "POST", { id, status });
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex gap-3">
                    <button className="group/show relative z-0" onClick={() => approve(req.id)}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <button className="group/show relative z-0" onClick={() => reject(req.id)}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
