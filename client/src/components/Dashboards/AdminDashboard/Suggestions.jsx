...
function Suggestions() {
  ...
  const getSuggestions = async () => {
    ...
    const data = await apiRequest("suggestion/hostel", "POST", { hostel: hostel._id });
  ...
  const updateSuggestion = async (id) => {
    setLoader(true);
    const data = await apiRequest("suggestion/update", "POST", { id, status: "approved" });
            ...
            suggestions.map((suggestion) => (
              ...
              >
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button className="group/show relative z-0" onClick={() => updateSuggestion(suggestion._id)}>
                    {loader ? (
                      <Loader />
                    ) : (
                      <svg
